<?php
    ...
    $string['table_header_time_enrolled'] = "Time Enroled";
    $string['table_header_time_started'] = "Time Started";
    $string['table_header_time_completed'] = "Time Finished";
    $string['table_header_reaggregate'] = "Reaggregate";
    $string['table_header_firstname'] = "First Name";
    ...
    $string['form:timecompletedafter'] = "Finished After:";
    $string['form:timecompletedbefore'] = "Finished Before:";
    $string['form:timestartedafter'] = "Started After:";
    $string['form:timestartedbefore'] = "Started Before:";
    $string['form:coursename'] = "Course Name:";
    $string['form:andor'] = "Sort Options:";
    $string['form:cohorts'] = "Cohorts:";

    $string['and'] = "Match Every Field";
    $string['or'] = "Match Any Field";
